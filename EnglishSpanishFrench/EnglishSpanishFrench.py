...
# Test an audio file
def testLanguageProbability(audio_file_path: str)-> ConfidenceScore:
    ...
    for i, class_label in enumerate(classes):
        ...
        if class_label == 'English':
            result.englishProbability= class_probabilities[i] * 100
        elif class_label == 'Spanish':
            result.spanishProbability = class_probabilities[i] * 100
        elif class_label == 'French':
            result.frenchProbability = class_probabilities[i] * 100

    # Calculate and display the predicted class and accuracy
    result.language = classes[predicted_class_index]
    result.accuracy = class_probabilities[predicted_class_index] * 100
    return result